...
const knownDeviceType = {
    ...
    'A3R8XIAIU4HJAX':   {name: 'Amazon Echo Show', commandSupport: true, icon: '/icons/echo.png'}, // AMAZON_MUSIC,MUSIC_SKILL,CHANGE_NAME,I_HEART_RADIO,TUNE_IN,SUPPORTS_CONNECTED_HOME_CLOUD_ONLY,PEONY,REMINDERS,AUDIO_PLAYER,PANDORA,VOLUME_SETTING,LAMBDA_DOWNCHANNEL

	//TODO name	#185
	'A378ND93PD0NC4':   {name: 'todo', commandSupport: true, icon: 'TODO'}, // CHANGE_NAME,KINDLE_BOOKS,DEREGISTER_DEVICE,I_HEART_RADIO,REMINDERS,MUSIC_SKILL,TUNE_IN,VOLUME_SETTING,PAIR_BT_SINK,MICROPHONE,AUDIBLE,SLEEP,DREAM_TRAINING,GOLDFISH,AMAZON_MUSIC,SUPPORTS_CONNECTED_HOME_CLOUD_ONLY,PEONY,AUDIO_PLAYER,PERSISTENT_CONNECTION,TIMERS_AND_ALARMS)
};
